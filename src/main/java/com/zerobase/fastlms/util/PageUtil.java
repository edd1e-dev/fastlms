...
public class PageUtil {
    ...
    public PageUtil(long totalCount, long pageSize, long pageIndex, String queryString, String beforeString) {
    ...
    public String pager() {
        ...
        sb.append(String.format("<a href='?pageIndex=%d%s%s'>&lt;&lt;</a>", 1, addQueryString, beforeString));
        sb.append(System.lineSeparator());
        sb.append(String.format("<a href='?pageIndex=%d%s%s'>&lt;</a>", previousPageIndex, addQueryString, beforeString));
        sb.append(System.lineSeparator());

        for(long i = startPage; i<= endPage; i++) {
            if (i == pageIndex) {
                sb.append(String.format("<a class='on' href='?pageIndex=%d%s%s'>%d</a>", i, addQueryString, beforeString, i));
            } else {
                sb.append(String.format("<a href='?pageIndex=%d%s%s'>%d</a>", i, addQueryString, beforeString, i));
            }
            sb.append(System.lineSeparator());
        }

        sb.append(String.format("<a href='?pageIndex=%d%s%s'>&gt;</a>", nextPageIndex, addQueryString, beforeString));
        sb.append(System.lineSeparator());
        sb.append(String.format("<a href='?pageIndex=%d%s%s'>&gt;&gt;</a>", totalBlockCount, addQueryString, beforeString));
        sb.append(System.lineSeparator());
